...
struct Color
{
    ...
    bool equals(const Color& a, const unsigned char variance) const { return equals(a.red, a.green, a.blue, variance); }
...
struct Pixel
{
    ...
    bool colorEquals(const Pixel* a, const unsigned char variance) const { return color.equals(a->color, variance); }

    bool colorEquals(const Color& a, const unsigned char variance) const { return color.equals(a, variance); }
...
public:
    ...
    void getPixelsInShape(
        std::vector<Pixel*>& foundPixel, int xCenter, int yCenter, int radius, Shape shapeToUse = SQUARE_SHAPE);
    ...
    void drawLine(int xStart, int yStart, int xEnd, int yEnd, unsigned char red, unsigned char green,
        unsigned char blue, int lineWidth = 1);
    ...
    void drawCross(
        int x, int y, int crossSize, unsigned char red, unsigned char green, unsigned char blue, int lineWidth = 1);
