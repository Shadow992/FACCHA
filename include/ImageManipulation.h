...
namespace ImageFramework
{
    ...
    Image* convolutionFilter(
        Image* img, float* filter, int filterWidth, int filterHeight, bool needsNormalization = false);
    Image* convolutionFilter(
        Image* img, std::vector<float>& filter, int filterWidth, int filterHeight, bool needsNormalization = false);
    void convertToGrayscaleImage(Image* img, bool equalWeights = false);
    void erode(std::vector<bool>& binPixel, int widthBinPixel, int heightBinPixel, int radiusWidthDilation,
        int radiusHeightDilation);
    void dilate(std::vector<bool>& binPixel, int widthBinPixel, int heightBinPixel, int radiusWidthDilation,
        int radiusHeightDilation);
