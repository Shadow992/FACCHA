...
namespace ImageFramework
{
    ...
    int countPixelAlternationsRingMorphology(const std::vector<Pixel*>& pixelData, int mean, int& countBlackArea1,
        int& countBlackArea2, int& countWhiteArea1, int& countWhiteArea2);
