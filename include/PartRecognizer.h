...
public:
    ...
    int getBestMatchingPart(DistanceTransformation& distanceTransformedImg, int& bestScaling, float& bestScore, int x,
        int y, int width, int height, int threshold = 100000000);
