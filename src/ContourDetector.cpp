...
void ContourDetector::performHysteresisRec(std::vector<OrientedGradient>& inputOG, int widthOG, int heightOG,std::vector<bool>& visited, int x, int y, int low, int high, int minPts, int& countEdgePoints)
{
    ...
    if(inputOG[currIdx].gradientMagnitude>low)
    {
        ...
        for(int yNeighbour=-1;yNeighbour<2;yNeighbour++)
        {
            ...
            {
                performHysteresisRec(inputOG, widthOG, heightOG,visited,x+xNeighbour,y+yNeighbour,low,high, minPts,countEdgePoints);
            }
        }
...
void ContourDetector::performHysteresis(std::vector<OrientedGradient>& inputOG, int widthOG, int heightOG, int low, int high, int minPts)
{
...
std::vector<OrientedGradient> ContourDetector::extractContours(Image& img, int radius, int threshold, int hysteresisThreshLow, int hysteresisThreshHigh, int minPts)
{
