...
unsigned char Image::getPixelGrayValue(int x, int y) const
{
    return imgData[x+y*width].color.red;
}
...
void Image::drawLine(int xStart, int yStart, int xEnd, int yEnd, unsigned char red,unsigned char green,unsigned char blue, int lineWidth)
{
...
void Image::drawCross(int x, int y, int crossSize, unsigned char red, unsigned char green, unsigned char blue, int lineWidth)
{
