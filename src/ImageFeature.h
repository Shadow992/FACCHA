...
namespace ImageFramework
{
	...
	void removeSmallRegions(std::vector<bool>& binarizedImage, int width, int height, int minSize, int radius, bool groupingColor);
	...
	Mat getSaliencyMap(Mat& img, int smallWindowSize, int scaleStep, int startingScale, int endingScale, int randomOtherRegions);
}
